        ...
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                leading: AppbarImage(
                    ...
                    margin:
                        EdgeInsets.only(left: 23.h, top: 16.v, bottom: 16.v),
                    onTap: () {
                      onTapArrowleftone();
                    }),
                ...
                title: AppbarTitle(
                    text: "lbl_profile".tr, margin: EdgeInsets.only(left: 1.h)),
                        ...
                        children: [
                          Container(
                              padding: EdgeInsets.symmetric(
                                  horizontal: 115.h, vertical: 22.v),
                              decoration: AppDecoration
                                  .gradientDeepPurpleToSecondaryContainer,
                              child: Card(
                          ...
                          Padding(
                              ...
                              child: Text("lbl_gender".tr,
                                  style:
                                      CustomTextStyles.labelLargeGray40002_1)),
                          Padding(
                              padding: EdgeInsets.only(left: 24.h, top: 1.v),
                              child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    CustomImageView(
            ...
            bottomNavigationBar: CustomElevatedButton(
                ...
                margin:
                    EdgeInsets.only(left: 24.h, right: 23.h, bottom: 25.v))));
  }
